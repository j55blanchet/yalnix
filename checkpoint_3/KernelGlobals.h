...
extern queue_t RUNNING;       // First initialized in KernelStart().
extern queue_t READY;         // First initialized in KernelStart().
extern queue_t CLOCK_WAITING; // First initialized in KernelStart().
// ======== ======== ======== ======== ======== ======== ======== ========
...
// single use T/F flag that indicates whether KernelStart has already created an init procss
extern int init_is_started;
