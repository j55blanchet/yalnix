...
int main(void) {
  ...
  char* prompt = "Type in a message to test TtyRead(): ";
  ...
  char* response = "00 >> I read: ";
  TtyWrite(0, response, strlen(response));
  TtyWrite(0, buffer, strlen(buffer));

  char* quit = "00 >> I will not quit.";
  TtyWrite(0, quit, strlen(quit));
